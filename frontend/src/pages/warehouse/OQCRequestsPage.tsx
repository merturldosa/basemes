...
const OQCRequestsPage: React.FC = () => {
  ...
  const loadInspections = async () => {
    ...
    try {
      ...
      setError(getErrorMessage(err, 'OQC 의뢰 목록을 불러오는데 실패했습니다.'));
    } finally {
      setLoading(false);
    }
  };
    ...
    <Box sx={{ width: '100%', p: 3 }}>
      ...
      <Alert severity="info" sx={{ mb: 2 }}>
        <Typography variant="body2">
          <strong>OQC (Outgoing Quality Control)</strong>: 출하 전 완제품에 대한 품질 검사 의뢰 목록입니다.
          <br />
          검사 결과에 따라 출하 승인 또는 출하 보류됩니다.
        </Typography>
      </Alert>
...
export default OQCRequestsPage;
