...
Progressive Web App (PWA) functionality for the SoIce MES Platform has been implemented with:
...
2. Updated app names (SoIce MES - Manufacturing Execution System)
...
```json
{
  "name": "SoIce MES - Manufacturing Execution System",
  "short_name": "SoIce MES",
  "description": "소프트아이스 제조실행시스템 - 생산관리, 품질관리, 재고관리",
  "start_url": "/",
  "display": "standalone",
  "theme_color": "#1976d2",
...
- `soice-mes-v1` - Static assets
- `soice-mes-api-v1` - API responses
...
# Settings → Apps → SoIce MES → Uninstall
```
...
The SoIce MES Platform now has **production-ready PWA capabilities** with:
...
**Date**: 2026-01-27
**Project**: SoIce MES Platform v1.1.0
