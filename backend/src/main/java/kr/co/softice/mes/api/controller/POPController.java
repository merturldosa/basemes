...
public class POPController {
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<WorkProgressEntity>> startWorkOrder(
            @PathVariable Long id,
            @RequestParam Long operatorId) {

        String tenantId = TenantContext.getCurrentTenant();
        WorkProgressEntity progress = popService.startWorkOrder(tenantId, id, operatorId);
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<WorkProgressEntity>> recordProgress(
            @RequestParam Long progressId,
            @RequestParam Integer quantity,
            @RequestParam Long operatorId) {

        String tenantId = TenantContext.getCurrentTenant();
        WorkProgressEntity progress = popService.recordProgress(tenantId, progressId, quantity, operatorId);
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<WorkProgressEntity>> pauseWork(
            @PathVariable Long id,
            @RequestParam(required = false) String reason) {

        String tenantId = TenantContext.getCurrentTenant();
        WorkProgressEntity progress = popService.pauseWork(tenantId, id, reason);
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<WorkProgressEntity>> resumeWork(@PathVariable Long id) {
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<WorkProgressEntity>> getWorkProgress(@PathVariable Long id) {
